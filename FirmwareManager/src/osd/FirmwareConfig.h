...
Menu firmwareConfigMenu("FirmwareConfigMenu", (uint8_t*) OSD_FIRMWARE_CONFIG_MENU, MENU_FWCONF_FIRST_SELECT_LINE, MENU_FWCONF_LAST_SELECT_LINE, [](uint16_t controller_data, uint8_t menu_activeLine, bool isRepeat) {
